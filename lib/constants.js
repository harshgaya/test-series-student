...
export const SITE_DESCRIPTION =
  "Practice MCQs, attempt mock tests, and crack NEET & JEE with India's most trusted test series platform.";

// Support
export const SUPPORT_WHATSAPP = "+919304136129";
...
// Free limits
export const FREE_VIDEO_SOLUTIONS = false;
export const FREE_ALL_INDIA_RANK = false;
export const FREE_CHAPTER_ANALYSIS = false;
...
export const DEFAULT_EXAM_COLOR = {
  bg: "#F8FAFC",
  text: "#475569",
  border: "#E2E8F0",
};
